  ...
  describe "POST" do
    context "valid user" do
      before :each do
        ...
        @params = { user: { name: "Name", email: "email@email", password: password, password_confirmation: password }}
    ...
    context "missing name" do
      before :each do
        password = SecureRandom.hex(6)
        @params = { user: { name: "", email: "email@email", password: password, password_confirmation: password }}
      end
